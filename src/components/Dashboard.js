      ...
      >
        ...
        >
          <div className="row mx-2 my-5">
            <div
              className="col-12 col-sm-6 col-md-4 col-lg-3 shadow-1-strong"
            ...
            <div className="col-12 col-sm-6 col-md-8 col-lg-9">
              ...
              <div className="tab-content" id="v-pills-tabContent">
                ...
                >
                  ...
                  <form className="row my-4" style={{ margin: "3% 0 0 2%" }}>
                ...
                >
                  ...
                  <form className="table-responsive my-5 mx-4">
                    <div className="mb-4 " style={{ left: "35%" }}>
                      <table class="table align-middle mb-0 bg-white">
                        <thead class="bg-light">
                          <tr>
                            <th style={{ color: "black" }}>Case Id</th>
                ...
                >
                  ...
                  <form className="table-responsive my-5 mx-4">
                    <div className="mb-4 " style={{ left: "35%" }}>
                      <div classNameName="mx-4 my-5 mx-sm-0 my-sm-0 table-responsive">
